...
kind: "individual" | "group" | "inattivita" | "scadenza" | "pagamento" | "prezzo_gruppo" | "nuovo_iscritto";
date: string | null;
...
setOpen(false);
// I promemoria (cliente inattivo / abbonamento in scadenza / nuovo
// iscritto) non sono legati a una giornata specifica: portano alla
// scheda del cliente.
if (
n.kind === "inattivita" ||
n.kind === "scadenza" ||
